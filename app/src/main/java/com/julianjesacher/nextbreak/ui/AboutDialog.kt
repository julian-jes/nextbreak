...
@Composable
fun AboutDialog(viewModel: MainViewModel) {
    Dialog(onDismissRequest = {
        viewModel.setAboutDialog(false)
    }) {
        Surface(
            ...
            AboutDialogContent(viewModel)
        }
    }
}

@Composable
fun AboutDialogContent(viewModel: MainViewModel) {
...
fun AboutWindowPreview() {
    NextBreakTheme {
        Surface(
            ...
            AboutDialogContent(MainViewModel(Application()))
        }
